public struct Triangle : IPolygon
{
    ...
    public Vector3 Normal => Vector3.CrossProduct(Vertex1 - Vertex2, Vertex3 - Vertex2);
    public Vector3[] Vertices => new Vector3[] { Vertex1, Vertex2, Vertex3 };
    public Vector3 GeometryCenter => (Vertex1 + Vertex2 + Vertex3) / 3;
    ...
    public Plane ToPlane() => Plane.FromTriangle(ref this);
    ...
    public bool CheckForIntersection(ref Line line, out Vector3 IntersectionPoint)
    {
        ...
        if (!ToPlane().CheckForIntersection(line, out Vector3 PlaneIntersectionPoint))
            return false;
        ...
        Vector3 Cross3 = Vector3.CrossProduct(ref Vertex3Local, ref Vertex1Local);
        
        double Dot1 = Vector3.DotProduct(ref Cross1, ref Cross2);
        double Dot2 = Vector3.DotProduct(ref Cross2, ref Cross3);
        double Dot3 = Vector3.DotProduct(ref Cross3, ref Cross1);
